...
| [0016](0016-codex-full-guarantee-parity.md) | Codex reaches full fail-closed parity because its PreToolUse hooks block, but only once hook trust is persisted | active |
