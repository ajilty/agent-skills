...
name: researcher
description: >-
  Explore code and the web; return confidence- and provenance-labeled findings
  with machine-checkable backing. Read-only. Doubles as Troubleshooter in a
  fresh diagnostic instance. Use during Planning (discovery) and Troubleshooting.
---
